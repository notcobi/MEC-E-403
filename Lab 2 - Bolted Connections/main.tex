...
\begin{titlepage}
    ...
    \Huge {Bolted Connections: \\An Investigation of Effects of Torque, Preload, and Gaskets on Bolted Connections} \\
...
\FloatBarrier
\input{Appendix/zero preload analysis.tex}
\newpage
\input{Appendix/preload vs torque.tex}
\newpage
\input{Appendix/shakedown.tex}
\newpage
\input{Appendix/bolt stiffness.tex}
\newpage
\input{Appendix/theoretical member stiffness.tex}
\newpage
\input{Appendix/experimental member stiffness.tex}
\newpage
\input{Appendix/joint seperation.tex}
\newpage
\input{Appendix/dynamic loading.tex}
