...
# load in the data
df = pd.read_excel(r"Lab 2 - Bolted Connections\matplotlib\torsten data\total_data.xlsx")
...
# save the results
results.to_csv(r"Lab 2 - Bolted Connections\matplotlib\torsten data\results.csv", index=False)
