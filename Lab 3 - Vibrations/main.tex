...
\FloatBarrier
\input{Appendix/spring stiffness.tex}
\newpage
\FloatBarrier
\input{Appendix/damping ratio.tex}
\newpage
\FloatBarrier
\input{Appendix/natural frequency.tex}
\newpage
\FloatBarrier
\input{Appendix/dmf.tex}
\newpage
\FloatBarrier
\input{Appendix/equivalent mass.tex}
\newpage
\FloatBarrier
\input{Appendix/experimental effective mass.tex}
\newpage
\FloatBarrier
\input{Appendix/table dump.tex}
\end{document}