...
\fancyhead[C]{Lab 6: Temperature Measurement Devices} % Center header
...
\begin{titlepage}
    ...
    % Title
    \Huge {MEC E 301 \\Lab 6: Temperature Measurement Devices} \\
    ...
    % Date
    \Large Date: November 21, 2023 \\ % or manually specify a date
